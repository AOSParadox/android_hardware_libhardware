...
typedef enum {
    ...
    POWER_FEATURE_DRAW_C = 0x00000003,
    POWER_FEATURE_DRAW_E = 0x00000004,
    POWER_FEATURE_DRAW_V = 0x00000005,
    POWER_FEATURE_DRAW_INVERSE_V = 0x00000006,
    POWER_FEATURE_DRAW_O = 0x00000007,
    POWER_FEATURE_DRAW_M = 0x00000008,
    POWER_FEATURE_DRAW_W = 0x00000009,
    POWER_FEATURE_DRAW_ARROW_LEFT = 0x0000000A,
    POWER_FEATURE_DRAW_ARROW_RIGHT = 0x0000000B,
    POWER_FEATURE_ONE_FINGER_SWIPE_UP = 0x0000000C,
    POWER_FEATURE_ONE_FINGER_SWIPE_RIGHT = 0x0000000D,
    POWER_FEATURE_ONE_FINGER_SWIPE_DOWN = 0x0000000E,
    POWER_FEATURE_ONE_FINGER_SWIPE_LEFT = 0x0000000F,
    POWER_FEATURE_TWO_FINGER_SWIPE = 0x00000010
} feature_t;
